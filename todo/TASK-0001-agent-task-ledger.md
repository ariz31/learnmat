...
This is the bootstrap task for the task-ledger protocol itself. The initial TODO is created before substantive implementation; it will then be claimed into implementing/ on this branch.
