...
- Asset ID and version: str-truss-load-path 0.2.0
...
The method-of-joints solution remains unchanged. For L=8 m, h=3 m and P=40 kN, reactions are 20 kN each, AB/BC are 33.333 kN compression and AC is 26.667 kN tension. The cylindrical 3D rendering does not introduce additional analytical members.
