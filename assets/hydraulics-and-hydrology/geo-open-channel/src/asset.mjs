...
export function createAsset(context={}){
 ...
 let disposed=false,timeSeconds=0,parameters={...DEFAULTS},state=computeOpenChannel(parameters);
 ...
 function rebuild(){
   dynamic.clear();particles=[];ownedGeometries=ownedGeometries.filter(g=>g===ground.geometry);
