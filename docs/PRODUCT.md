...
Make high-quality civil-engineering learning assets discoverable and reusable in
...
Public viewing and downloading of approved assets should not require an account.
Maintenance writes remain authenticated and repository-controlled. Intended public
reuse requires an explicit per-asset license; visibility alone grants no license.

## Scope of this delivery

Repository documentation, metadata conventions, templates, instruction library,
and the five supplied examples. No asset gallery app, upload dashboard, backend,
production deployment, engineering certification, or connector installation is
implemented in this package.

## Initial content

Surveying: pacing, taping, differential leveling, profile leveling, and compass
traversing. Other civil-engineering categories are reserved for future contributions.
Source quality varies; supplied examples are references for improvement, not a
mandatory visual standard or pre-approved production implementation.
